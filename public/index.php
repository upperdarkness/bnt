...
$router->post('/admin/universe/sector/:id/link/create', fn($id) => $adminController->createLink((int)$id));
$router->post('/admin/universe/sector/:id/link/delete', fn($id) => $adminController->deleteLink((int)$id));
